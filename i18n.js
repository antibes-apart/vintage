...
const en = {
  ...
  guideLeCreusetTimeline1925Text: 'Le Creuset is founded at Fresnoy-le-Grand and begins its enameled cast-iron production. Volcanique establishes colour as part of the object rather than a decorative afterthought, setting a visual direction that remains central to the house.',
  guideLeCreusetTimeline1950Title: 'Form & Colour',
  guideLeCreusetTimeline1950Text: 'The official archives describe the decade as a period of increasingly adventurous colour and form. The Rayure collection used a distinctive vertical gradient, while the documented 1955 Alpine skillet combined a curved body, beech handle and satin-black enamel interior.',
  guideLeCreusetTimelineLoewyTitle: 'Raymond Loewy',
  guideLeCreusetTimelineLoewyText: 'Le Creuset dates its invitation to Raymond Loewy and the Coquelle collaboration to 1958. The Centre Pompidou collection record catalogues Coquelle as 1958–1975 and notes “designed in 1960.” That institutional record places the enameled cast-iron cocotte within a major public design collection without erasing the difference between collaboration, design and production dates.',
  guideLeCreusetTimelineMariTitle: 'Enzo Mari / La Mama',
  guideLeCreusetTimelineMariText: 'Le Creuset introduced La Mama with Enzo Mari in 1972. Clean geometry and a characteristic T-shaped lid handle give the collection a distinct identity, connecting practical cookware with Mari’s wider concern for direct, functional form.',
  ...
  guideLeCreusetDesignerMariText: 'La Mama’s restrained bodies and unmistakable T-shaped lid handles make the collection visually economical rather than ornamental. That economy is consistent with Le Creuset’s own account of Mari’s commitment to honest, functional design, while individual pieces still require careful documentation of size, form and period.',
  ...
  guideLeCreusetArchiveMamaCaption: 'La Mama cocotte — Enzo Mari for Le Creuset. The collection was introduced in 1972; the production date of the individual archive object will be documented with its photograph.',
  ...
  guideLeCreusetRefIntro: 'Sources are ordered by evidential weight. Manufacturer archives support the company chronology and named collections; the museum record supports Coquelle’s design attribution and institutional dating. Marketplace material is retained only as secondary evidence of a surviving object or brochure and is not used to establish the history above.',
  guideLeCreusetRefOfficialLabel: 'Official Le Creuset archives and heritage material',
  guideLeCreusetRefOfficialText: 'The principal sources for the foundation, colours, historical forms and named designer collaborations.',
  ...
  guideLeCreusetRefMuseumLabel: 'Museum collection',
  guideLeCreusetRefMuseumText: 'Institutional catalogue evidence for Raymond Loewy’s Coquelle, including maker, material, collection dates and design note.',
  guideLeCreusetRefPompidou: 'Centre Pompidou — Cocotte Coquelle, Raymond Loewy',
  guideLeCreusetRefSecondaryLabel: 'Secondary supporting material',
  guideLeCreusetRefSecondaryText: 'Auction aggregation is not treated as authority for attribution or dating; this entry is included only as a record of a lot described with a Coquelle brochure.',
  guideLeCreusetRefBarnebys: 'Barnebys — Coquelle lot with brochure (secondary reference)',
...
const fr = {
  ...
  guideLeCreusetTimeline1925Text: 'Le Creuset est fondé à Fresnoy-le-Grand et commence sa production de fonte émaillée. Volcanique fait de la couleur une composante de l’objet plutôt qu’un ajout décoratif, établissant une direction visuelle qui restera centrale pour la maison.',
  guideLeCreusetTimeline1950Title: 'Forme & couleur',
  guideLeCreusetTimeline1950Text: 'Les archives officielles décrivent la décennie comme une période d’expérimentation croissante sur la couleur et la forme. La collection Rayure emploie un dégradé vertical distinctif, tandis que la poêle Alpine documentée en 1955 associe corps incurvé, manche en hêtre et intérieur en émail noir satiné.',
  guideLeCreusetTimelineLoewyTitle: 'Raymond Loewy',
  guideLeCreusetTimelineLoewyText: 'Le Creuset date de 1958 son invitation à Raymond Loewy et la collaboration autour de Coquelle. La notice du Centre Pompidou catalogue Coquelle entre 1958 et 1975 et précise « Dessinée en 1960 ». Cette notice institutionnelle inscrit la cocotte en fonte émaillée dans une grande collection publique de design sans effacer la différence entre date de collaboration, de dessin et de production.',
  guideLeCreusetTimelineMariTitle: 'Enzo Mari / La Mama',
  guideLeCreusetTimelineMariText: 'Le Creuset lance La Mama avec Enzo Mari en 1972. Une géométrie épurée et une poignée de couvercle caractéristique en T donnent à la collection une identité propre, reliant l’ustensile pratique à l’intérêt plus large de Mari pour une forme directe et fonctionnelle.',
  guideLeCreusetTimelineFuturaTitle: 'Jean-Louis Barrault / Futura',
  ...
  guideLeCreusetDesignerMariEyebrow: 'Enzo Mari',
  guideLeCreusetDesignerMariTitle: 'La Mama',
  guideLeCreusetDesignerMariText: 'Les corps sobres et les poignées de couvercle en T immédiatement reconnaissables rendent La Mama visuellement économe plutôt qu’ornementale. Cette économie correspond au récit que donne Le Creuset de l’engagement de Mari pour un design honnête et fonctionnel, tandis que chaque pièce exige encore une documentation attentive de sa taille, de sa forme et de sa période.',
  guideLeCreusetDesignerBarraultEyebrow: 'Jean-Louis Barrault',
  guideLeCreusetDesignerBarraultTitle: 'Futura',
  ...
  guideLeCreusetArchiveMamaCaption: 'Cocotte La Mama — Enzo Mari pour Le Creuset. La collection est lancée en 1972 ; la date de production de l’objet d’archive sera documentée avec sa photographie.',
  ...
  guideLeCreusetRefIntro: 'Les sources sont classées selon leur poids documentaire. Les archives du fabricant étayent la chronologie de l’entreprise et les collections nommées ; la notice de musée confirme l’attribution et la datation institutionnelle de Coquelle. Les éléments de marketplace ne sont conservés que comme preuve secondaire d’un objet ou d’une brochure et ne fondent pas l’histoire exposée ci-dessus.',
  guideLeCreusetRefOfficialLabel: 'Archives et patrimoine officiels Le Creuset',
  guideLeCreusetRefOfficialText: 'Sources principales pour la fondation, les couleurs, les formes historiques et les collaborations nommées.',
  ...
  guideLeCreusetRefMuseumLabel: 'Collection de musée',
  guideLeCreusetRefMuseumText: 'Notice institutionnelle consacrée à la Coquelle de Raymond Loewy, avec fabricant, matériau, dates de collection et note de dessin.',
  guideLeCreusetRefPompidou: 'Centre Pompidou — Cocotte Coquelle, Raymond Loewy',
  guideLeCreusetRefSecondaryLabel: 'Documentation secondaire',
  guideLeCreusetRefSecondaryText: 'Un agrégateur de ventes ne fait pas autorité pour l’attribution ou la datation ; cette entrée est incluse uniquement comme trace d’un lot décrit avec une brochure Coquelle.',
  guideLeCreusetRefBarnebys: 'Barnebys — lot Coquelle avec brochure (référence secondaire)',
