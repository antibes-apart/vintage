...
const en = {
  ...
  guideLeCreusetDatingProcess4: 'Handles & Knob',
  ...
  guideLeCreusetDatingHeroAlt: 'Complete profile of a vintage Le Creuset cocotte',
  guideLeCreusetDatingHeroCaption: 'Complete object profile — original Cook & Collect comparison photograph to be added.',
  ...
  guideLeCreusetDatingShapeEarlierAlt: 'Earlier Le Creuset cocotte form for documented comparison',
  guideLeCreusetDatingShapeEarlierCaption: 'Earlier form — date range to be added only after a documented catalogue comparison.',
  guideLeCreusetDatingShapeOtherAlt: 'Alternative Le Creuset cocotte form for documented comparison',
  guideLeCreusetDatingShapeOtherCaption: 'Transitional or alternative form — relationship and period still to be researched.',
  guideLeCreusetDatingShapeLaterAlt: 'Later Le Creuset cocotte form for documented comparison',
  guideLeCreusetDatingShapeLaterCaption: 'Later form — date range to remain blank until supported by documentary evidence.',
  ...
  guideLeCreusetDatingBaseAlt: 'Underside of a vintage Le Creuset cocotte',
  guideLeCreusetDatingBaseCaption: 'Complete underside — photograph the finish, rings, lettering and numbers together.',
  guideLeCreusetDatingBaseMarkAlt: 'Le Creuset lettering and casting marks on a cocotte base',
  guideLeCreusetDatingBaseMarkCaption: 'Base inscription detail — original Cook & Collect macro photograph to be added.',
  ...
  guideLeCreusetDatingS4Heading: '4. Examine the Handles and Knob',
  guideLeCreusetDatingS4P1: 'Handles are part of the cast form or attached construction, so they can help distinguish object families, specific designer pieces and changes between documented versions. Look at them as engineered features rather than decoration.',
  ...
  guideLeCreusetDatingS4P3: 'For the lid knob, photograph the top, profile and attachment. Phenolic, metal and cast constructions may provide useful comparative evidence, but a knob is also one of the easiest components to replace after wear, damage or a change in use.',
  guideLeCreusetDatingHandleAlt: 'Handle and knob construction on vintage Le Creuset cookware',
  guideLeCreusetDatingHandleCaption: 'Side-handle, long-handle and knob details should be photographed from consistent angles.',
  guideLeCreusetDatingS4Note: 'A replacement knob can make an older piece appear newer — or vice versa. The knob should therefore never be used as the sole dating criterion.',

  guideLeCreusetDatingS5Heading: '5. Study the Lid',
  guideLeCreusetDatingS5P1: 'A lid should be examined as a separate object and then as part of the vessel. Record its profile and curvature, rim construction, knob attachment, underside, internal features, casting marks and fit. The way the lid meets the body can be as informative as the visible top surface.',
  guideLeCreusetDatingLidProfileAlt: 'Profile of a vintage Le Creuset cocotte lid',
  guideLeCreusetDatingLidProfileCaption: 'Lid profile and rim — comparative side view to be photographed by Cook & Collect.',
  guideLeCreusetDatingLidUndersideAlt: 'Underside and casting details of a vintage Le Creuset lid',
  guideLeCreusetDatingLidUndersideCaption: 'Lid underside, attachment and casting details — original comparison photograph to come.',
  ...
  guideLeCreusetDatingEnamelAlt: 'Vintage Le Creuset enamel colour and surface detail',
  guideLeCreusetDatingEnamelCaption: 'Enamel colour, gradient, gloss and wear — original neutral-light detail to be added.',
  ...
  guideLeCreusetDatingExamplesIntro: 'This section is prepared for documented case studies using original Cook & Collect photographs and measurements. No sample history or date has been filled in before an object is selected and its comparison sources are recorded.',
  guideLeCreusetDatingExampleAlt: 'Vintage Le Creuset cocotte documented for a dating case study',
  guideLeCreusetDatingExampleCaption: 'Dating example No. 01 — original object photography and evidence record to be added.',
  guideLeCreusetDatingExampleLabel: 'Dating Example No. 01',
  guideLeCreusetDatingExampleTitle: 'Evidence record awaiting documentation',
  ...
  guideLeCreusetDatingExamplePending: 'To be recorded from the selected object',
  guideLeCreusetDatingEvidenceKeyTitle: 'Evidence labels used in future examples',
  ...
  guideLeCreusetDatingFaq7Q: 'Can a Le Creuset knob help date a cocotte?',
  guideLeCreusetDatingFaq7A: 'It can provide supporting evidence when it is original and documented, but knobs are replaceable and must never be the sole dating criterion.',

  guideLeCreusetDatingRefHeading: 'Research & References',
  guideLeCreusetDatingRefIntro: 'These sources provide documented examples of Le Creuset history, colours, forms and designer objects. They do not supply a universal dating key. This guide uses them only for claims they actually support and will be expanded as period catalogues, advertisements and original case studies are added.',
  ...
  guideLeCreusetDatingRefNextLabel: 'Research still to be added',
  guideLeCreusetDatingRefNextText: 'Period Le Creuset catalogues and advertisements will be added when located and checked. Until then, no missing chronology is filled from unattributed charts, forum posts or repeated marketplace descriptions.',
  ...
  guideLeCreusetDatingCardImageAlt: 'Complete profile and base details of vintage Le Creuset cookware',
...
const fr = {
  ...
  guideLeCreusetDatingProcess4: 'Poignées & bouton',
  ...
  guideLeCreusetDatingHeroAlt: 'Profil complet d’une cocotte Le Creuset vintage',
  guideLeCreusetDatingHeroCaption: 'Profil complet de l’objet — photographie comparative originale Cook & Collect à venir.',
  ...
  guideLeCreusetDatingShapeEarlierAlt: 'Forme ancienne de cocotte Le Creuset destinée à une comparaison documentée',
  guideLeCreusetDatingShapeEarlierCaption: 'Forme ancienne — plage de dates à ajouter uniquement après comparaison avec un catalogue documenté.',
  guideLeCreusetDatingShapeOtherAlt: 'Autre forme de cocotte Le Creuset destinée à une comparaison documentée',
  guideLeCreusetDatingShapeOtherCaption: 'Forme transitoire ou différente — relation et période encore à étudier.',
  guideLeCreusetDatingShapeLaterAlt: 'Forme plus tardive de cocotte Le Creuset destinée à une comparaison documentée',
  guideLeCreusetDatingShapeLaterCaption: 'Forme plus tardive — plage de dates laissée vide jusqu’à l’obtention de preuves documentaires.',
  ...
  guideLeCreusetDatingBaseAlt: 'Dessous d’une cocotte Le Creuset vintage',
  guideLeCreusetDatingBaseCaption: 'Vue complète du dessous — photographier ensemble finition, anneaux, lettres et numéros.',
  guideLeCreusetDatingBaseMarkAlt: 'Lettrage Le Creuset et marques de moulage sous une cocotte',
  guideLeCreusetDatingBaseMarkCaption: 'Détail des inscriptions de fond — macrophotographie originale Cook & Collect à venir.',
  ...
  guideLeCreusetDatingS4Heading: '4. Examiner les poignées et le bouton',
  guideLeCreusetDatingS4P1: 'Les poignées font partie de la forme moulée ou de la construction rapportée ; elles peuvent donc aider à distinguer des familles d’objets, des modèles de designers et des versions documentées. Lisez-les comme des éléments techniques plutôt que décoratifs.',
  ...
  guideLeCreusetDatingS4P3: 'Pour le bouton du couvercle, photographiez le dessus, le profil et la fixation. Les constructions phénoliques, métalliques ou en fonte peuvent fournir des indices comparatifs, mais le bouton est aussi l’un des éléments les plus faciles à remplacer après usure, casse ou changement d’usage.',
  guideLeCreusetDatingHandleAlt: 'Construction des poignées et boutons sur des ustensiles Le Creuset vintage',
  guideLeCreusetDatingHandleCaption: 'Poignées latérales, manches et boutons doivent être photographiés sous des angles constants.',
  guideLeCreusetDatingS4Note: 'Un bouton de remplacement peut faire paraître une pièce ancienne plus récente — ou l’inverse. Il ne doit donc jamais constituer le seul critère de datation.',

  guideLeCreusetDatingS5Heading: '5. Étudier le couvercle',
  guideLeCreusetDatingS5P1: 'Un couvercle doit être examiné comme un objet séparé, puis comme une partie du récipient. Relevez son profil et sa courbure, la construction du bord, la fixation du bouton, le dessous, les éléments internes, les marques de moulage et l’ajustement. La rencontre entre couvercle et corps peut être aussi informative que la surface supérieure visible.',
  guideLeCreusetDatingLidProfileAlt: 'Profil du couvercle d’une cocotte Le Creuset vintage',
  guideLeCreusetDatingLidProfileCaption: 'Profil et bord du couvercle — vue latérale comparative à photographier par Cook & Collect.',
  guideLeCreusetDatingLidUndersideAlt: 'Dessous et détails de moulage d’un couvercle Le Creuset vintage',
  guideLeCreusetDatingLidUndersideCaption: 'Dessous, fixation et détails de moulage — photographie comparative originale à venir.',
  ...
  guideLeCreusetDatingEnamelAlt: 'Couleur et détail de surface d’un émail Le Creuset vintage',
  guideLeCreusetDatingEnamelCaption: 'Couleur, dégradé, brillance et usure de l’émail — détail original sous lumière neutre à venir.',
  ...
  guideLeCreusetDatingExamplesIntro: 'Cette section est préparée pour des études de cas documentées avec photographies et mesures originales Cook & Collect. Aucun historique ni aucune date fictive n’est renseigné avant la sélection d’un objet et l’enregistrement de ses sources comparatives.',
  guideLeCreusetDatingExampleAlt: 'Cocotte Le Creuset vintage documentée pour une étude de datation',
  guideLeCreusetDatingExampleCaption: 'Exemple de datation n° 01 — photographie originale et dossier de preuves à venir.',
  guideLeCreusetDatingExampleLabel: 'Exemple de datation n° 01',
  guideLeCreusetDatingExampleTitle: 'Dossier de preuves en attente de documentation',
  ...
  guideLeCreusetDatingExamplePending: 'À relever sur l’objet sélectionné',
  guideLeCreusetDatingEvidenceKeyTitle: 'Niveaux de preuve des futurs exemples',
  ...
  guideLeCreusetDatingFaq7Q: 'Un bouton Le Creuset peut-il aider à dater une cocotte ?',
  guideLeCreusetDatingFaq7A: 'Il peut fournir un indice complémentaire s’il est d’origine et documenté, mais les boutons sont remplaçables et ne doivent jamais constituer le seul critère.',

  guideLeCreusetDatingRefHeading: 'Recherches & références',
  guideLeCreusetDatingRefIntro: 'Ces sources fournissent des exemples documentés de l’histoire, des couleurs, des formes et des objets de designers Le Creuset. Elles ne donnent pas de clé universelle de datation. Ce guide les emploie uniquement pour les affirmations qu’elles étayent réellement et s’enrichira avec l’ajout de catalogues, publicités et études de cas originales.',
  ...
  guideLeCreusetDatingRefNextLabel: 'Recherches à compléter',
  guideLeCreusetDatingRefNextText: 'Les catalogues et publicités Le Creuset d’époque seront ajoutés après localisation et vérification. En attendant, les lacunes chronologiques ne sont pas comblées par des tableaux sans source, des forums ou des descriptions répétées de marketplace.',
  ...
  guideLeCreusetDatingCardImageAlt: 'Profil complet et détails de base d’ustensiles Le Creuset vintage',
