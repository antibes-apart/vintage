...
const en = {
  ...
  guideLeCreusetMetaDesc: 'Explore vintage Le Creuset history, designer collaborations, colours and identifying features, from early French cocottes to Raymond Loewy and Enzo Mari.',
  ...
  guideLeCreusetHeroAlt: 'Vintage Le Creuset cast iron cookware from the Cook & Collect archive',
  guideLeCreusetHeroCaption: 'Cook & Collect archive overview — original photograph to be added.',
  ...
  guideLeCreusetDesignerMariText: 'Presented to the European press in 1972 and documented on the European market and in museum records in 1973, La Mama’s rounded bodies and unmistakable T-shaped lid handles make the collection visually economical rather than ornamental. Individual pieces still require separate examination of size, form, markings and construction before a production period is proposed.',
  ...
  guideLeCreusetArchiveIntro: 'This section is reserved for original Cook & Collect object photography and examination notes. It is an archive of handled pieces rather than a product grid: no prices, availability claims or shopping actions are attached to the records.',
  guideLeCreusetArchiveMamaAlt: 'Vintage Le Creuset La Mama cocotte designed by Enzo Mari',
  guideLeCreusetArchiveMamaCaption: 'La Mama cocotte — Enzo Mari for Le Creuset. The collection was presented in Europe in 1972 and entered the European market in 1973; the production date of the individual Cook & Collect archive object will be assessed separately from its photograph, markings and construction.',
  guideLeCreusetArchiveSkilletAlt: 'Vintage Le Creuset cast iron skillet from the Cook & Collect archive',
  guideLeCreusetArchiveSkilletCaption: 'Vintage Le Creuset skillet — period and model to be documented from the object, measurements and comparative sources.',
  guideLeCreusetArchiveCocotteAlt: 'Vintage Le Creuset cocotte from the Cook & Collect archive',
  guideLeCreusetArchiveCocotteCaption: 'Vintage Le Creuset cocotte — period and model to be documented; no date is assigned from appearance alone.',
  ...
  guideLeCreusetResearchGuidesIntro: 'This hub is designed to grow into a specialist content cluster. Dating and identification is now the first published child guide; the remaining subjects stay non-clickable until each researched page is ready.',
  ...
  guideLeCreusetCardImageAlt: 'Vintage Le Creuset cast iron cookware from the Cook & Collect archive',
...
const fr = {
  ...
  guideLeCreusetMetaDesc: 'Explorez l’histoire de Le Creuset vintage, ses designers, couleurs et indices d’identification, des premières cocottes à Raymond Loewy et Enzo Mari.',
  ...
  guideLeCreusetHeroAlt: 'Ustensiles Le Creuset vintage en fonte issus des archives Cook & Collect',
  guideLeCreusetHeroCaption: 'Vue d’ensemble des archives Cook & Collect — photographie originale à venir.',
  ...
  guideLeCreusetDesignerMariEyebrow: 'Enzo Mari',
  guideLeCreusetDesignerMariTitle: 'La Mama',
  guideLeCreusetDesignerMariText: 'Présentée à la presse européenne en 1972 puis documentée sur le marché européen et dans les collections de musée en 1973, La Mama se distingue par ses corps arrondis et ses poignées de couvercle en T. Chaque pièce exige néanmoins un examen séparé de sa taille, de sa forme, de ses marques et de sa construction avant de proposer une période de production.',
  guideLeCreusetDesignerBarraultEyebrow: 'Jean-Louis Barrault',
  guideLeCreusetDesignerBarraultTitle: 'Futura',
  ...
  guideLeCreusetArchiveIntro: 'Cette section est réservée aux photographies originales et aux notes d’examen de Cook & Collect. Il s’agit d’archives de pièces manipulées, non d’une grille de produits : aucun prix, aucune disponibilité et aucune action d’achat ne sont associés aux notices.',
  guideLeCreusetArchiveMamaAlt: 'Cocotte Le Creuset La Mama vintage dessinée par Enzo Mari',
  guideLeCreusetArchiveMamaCaption: 'Cocotte La Mama — Enzo Mari pour Le Creuset. La collection est présentée en Europe en 1972 et mise sur le marché européen en 1973 ; la date de production de l’objet des archives Cook & Collect sera évaluée séparément à partir de sa photographie, de ses marques et de sa construction.',
  guideLeCreusetArchiveSkilletAlt: 'Poêle Le Creuset vintage en fonte issue des archives Cook & Collect',
  guideLeCreusetArchiveSkilletCaption: 'Poêle Le Creuset vintage — période et modèle à documenter à partir de l’objet, de ses mesures et de sources comparatives.',
  guideLeCreusetArchiveCocotteAlt: 'Cocotte Le Creuset vintage issue des archives Cook & Collect',
  guideLeCreusetArchiveCocotteCaption: 'Cocotte Le Creuset vintage — période et modèle à documenter ; aucune date n’est attribuée d’après la seule apparence.',
  ...
  guideLeCreusetResearchGuidesIntro: 'Ce guide pilier est conçu pour devenir un ensemble de contenus spécialisés. La datation et l’identification constituent désormais le premier guide enfant publié ; les autres sujets restent non cliquables jusqu’à ce que chaque page soit documentée.',
  ...
  guideLeCreusetCardImageAlt: 'Ustensiles Le Creuset vintage en fonte issus des archives Cook & Collect',
